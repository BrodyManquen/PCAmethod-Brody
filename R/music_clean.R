#' Cleaned version of Music Genre Classification 'train' data set (renamed 'music')
#'
...
#'
#' Cleaning code to remove qualitative variables, NAs, and relabel grouping variable 'Class' (hide from analysis)
#' music_clean <- music |> dplyr::select(-"Artist Name", -"Track Name") |> tidyr::drop_na()
...
#'
#' @format ## `music_clean`
#' A data frame with 11,813 rows and 15 columns:
#' \describe{
...
#'   \item{Class}{Genre: Rock, Indie, Alt, Pop, Metal, HipHop, Alt_Music, Blues, Acoustic/Folk, Instrumental, Country, or Bollywood}
#'   ...
#' }
